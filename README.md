Project notes:
* This project was extremely challenging for me, but trial and error and using the developer console and console.log function I was able to provide the needed functionality to the application
* Made a few changes to the API
* Made changes to the isRemoval function
* Made notes as I went along
